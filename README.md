...
## Milestone 2 — GitHub OAuth, Private Repositories, Repository Management (in progress)
...
- [ ] Task 3 — The OAuth flow itself (connect, callback, disconnect)
- [ ] Task 3 — The OAuth flow itself (connect, callback, disconnect)
- [ ] Task 4 — Enable private repos in the existing import pipeline
- [ ] Task 5 — Repository management endpoints (list, delete)
